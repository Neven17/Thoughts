<nav class="navbar navbar-expand-lg bg-dark border-bottom border-bottom-dark sticky-top bg-body-tertiary" data-bs-theme="dark">
    <div class="container">
        <a class="navbar-brand fw-light" href="{{ route('dashboard') }}">
            {{ config('app.name') }}
            <img class="w-24" src="{{ asset('storage/logo/bijeli-oblak.png') }}" alt="Logo" style="width: 25px; height: 25px; margin-left: -2px; margin-bottom: 3px;  margin-top: -23px;">
        </a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  ms-4" href="{{ route('lang', 'en') }}">en</a> 
                </li>



                <li class="nav-item ">
                    <a class="nav-link " href="{{ route('lang', 'hr') }}">hr</a> 
                </li>
